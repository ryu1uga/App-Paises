 ...
 *   - dish / symbol   country-json (dataset heredado, sin fecha de corte)
 *
 ...
 * los años 90 (esperanza de vida), sin fecha de corte declarada.
 */
const fs = require('fs');
...
const symbolSrc = load('country-by-national-symbol.json');
...
const IDX = { dish: index(dishSrc, 'dish'), symbol: index(symbolSrc, 'symbol') };
...
const missing = { pop: [], life: [], currency: [], demonym: [] };
